...
contract SolveHash {
    ...
    bytes32 public hashString = 0x2f0c90ae22335c489464a78210c74852980bb0e028568fa604901de7c993d562;

    constructor() payable {}

    function solve(string memory guess) public { 
        require(keccak256(abi.encodePacked(guess)) == hashString, "Incorrect guess");
...
3. Bob then finds the keccak256(Address + Solution + Secret). 
   Address is his wallet address, solution is "Ethereum", Secret is like an password ("mysecret") 
...
3. Bob then calls commitSolution("0xf95b1dd61edc3bd962cdea3987c6f55bcb714a02a2c3eb73bd960d6b4387fc36"), 
   where he commits the calculated hash with gas price set to 15 gwei.
