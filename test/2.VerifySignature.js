...
describe("Signature Verification", () => {
    ...
    it("Sign message and verify", async () => {
        ...
        expect(await verifySignature.getSigner(message, signature)).to.be.equal(account1.address);
 
        expect(await verifySignature.getSigner("Hellotest message", signature)).not.to.be.equal(account1.address);
    })
