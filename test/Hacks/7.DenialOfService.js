...
describe("Denial Of Service", () => {
    ...
    it("King contract works as expected", async () => {
        ...
        await king.connect(account1).claimThrone({value: ethers.utils.parseEther("200")});
    ...
    it("Able to attack", async () => {
        ...
        await expect(king.claimThrone({value: ethers.utils.parseEther("120")})).to.be.revertedWith("Failed to send ether");
    });
