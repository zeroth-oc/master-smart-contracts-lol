...
describe("Bank", () => {
    ...
    describe("Bank works" , () => {
        it("Can deposit amount", async () => {
            ...
            expect(await bank.deposit({value : ethers.utils.parseEther("10")})).to.emit(bank, "LogMessagge").withArgs(account1.address, 'deposit', ethers.utils.parseEther("10"));
        ...
        it("Can withdraw amount", async () => {
            ...
            expect(await bank.getBalance()).to.be.equal(ethers.utils.parseEther("10")); 
            expect(await bank.withdraw()).to.emit(bank, "LogMessagge").withArgs(account1.address, 'withdraw', ethers.utils.parseEther("10"));
...
describe("Bank with malicious Log", () => {
    ...
    describe("Bank works" , () => {
        it("Can deposit amount", async () => {
            expect(await bank.getBalance()).to.be.equal(0);
            expect(await bank.deposit({value : ethers.utils.parseEther("10")})).to.emit(bank, "LogMessagge1").withArgs(account1.address, 'deposit', ethers.utils.parseEther("10"));
            expect(await bank.getBalance()).to.be.equal(ethers.utils.parseEther("10")); 
        });
        ...
        it("Can withdraw amount", async () => {
            ...
            expect(await bank.deposit({value : ethers.utils.parseEther("10")})).to.be.ok;
            expect(await bank.getBalance()).to.be.equal(ethers.utils.parseEther("10")); 
            expect(await bank.withdraw()).to.emit(bank, "LogMessagge1").withArgs(account1.address, 'withdraw', ethers.utils.parseEther("10"));
